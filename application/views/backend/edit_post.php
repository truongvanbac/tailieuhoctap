...
<div id="manager">
    ...
    <form class="form-horizontal" action="<?php echo base_url()?>post/edit_post/<?php echo $old_post[0]['ebook_id']?>" method="post">
        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">Tiêu đề <span>*</span></label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="title-name" name="title-edit" placeholder="Nhập tiêu đề" value="<?php echo $old_post[0]['ebook_ten']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="page-number" name="page-number-edit" value="<?php echo $old_post[0]['ebook_so_trang']?>" placeholder="Nhập số trang">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" rows="5" name="des-edit"><?php echo $old_post[0]['ebook_mieu_ta']?></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="user-up" name="user-up-edit" value="<?php echo $old_post[0]['ebook_user_up']?>">
            </div>
        </div>
